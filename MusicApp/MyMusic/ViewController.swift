...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func configureSongs() {
        songs.append(Song(name: "Shape of You",
                          ...
                          imageName: "Unknown",
                          trackName: "037_Ed_Sheeran_-_Shape_Of_You_Midi_Culture_Remix_(mp3.pm)"))
        songs.append(Song(name: "Blinding Lights",
                          albumName: "",
                          artistName: "The Weeknd",
                          imageName: "Unknown-1",
                          trackName: "the_weeknd_-_blinding_lights_slow_reverb_(mp3.pm)"))
        songs.append(Song(name: "Someone Like You",
                          albumName: "",
                          artistName: "Adele",
                          imageName: "Unknown-2",
                          trackName: "Cover_de_Adele_-_Someone_like_you_kto-to_kak_ty_(mp3.pm)"))
